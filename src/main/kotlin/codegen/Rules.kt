 ...
 */
enum class Elem {
    CLASS, FIELD, METHOD, IF, ELSE, FOR, VAR_DECL, METHOD_CALL, RETURN, EXCEPTION
}
...
val rules = hashMapOf(
    ...
    Elem.ELSE to listOf(Elem.IF, Elem.FOR, Elem.VAR_DECL, Elem.METHOD_CALL, Elem.RETURN, Elem.EXCEPTION),
